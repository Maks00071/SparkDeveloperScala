package Lesson11.DataFrame.Homework
...
Цель:
Выполнив домашнее задание, вы получите опыт работы с RDD API, DataFrame API, Dataset API.
Научитесь строить аналитическую витрину на основе сырых данных, используя Spark и различные API.
...
Результат вывести на экран и в txt файл с пробелами.
...
Результат вывести на экран и записать в файл Parquet.
...
Критерии оценки:
Выполнено Задание 1 - таблица выведена на экран и сохранена в формате parquet.
Выполнено Задание 2 - таблица выведена на экран и сохранена в формате txt.
Выполнено Задание 2 - таблица выведена на экран и сохранена в формате parquet.
 */

object HomeworkLesson11 {
